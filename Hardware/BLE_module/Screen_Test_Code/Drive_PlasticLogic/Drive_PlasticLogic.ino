...
#define EPD_RST     D4      // Please align with your individual wiring
#define EPD_BUSY    D10      // Please align with your individual wiring
#define EPD_CS      D5      // Please align with your individual wiring
...
void setup() {  
    ...
    SPI_Master.begin(D9, D7, D8);                    // Bus initialisation, UC8156 supp. max 10Mhz (writing)
    SPI_Master.setFrequency(500000);
    SPI_Master.beginTransaction();//and 6.6Mhz (reading)
